        ...
        <div class="flex justify-center items-center sm:gap-4 size-full text-white m-auto">
            ...
            <div class="flex flex-col items-center justify-center h-full gap-2 w-full md:w-auto">
                <div
                    ...
                    <img class="text-white pt-5 mb-3" width="175" height="51" src="/images/IG logo.svg"
                        alt="Instagram logo" />

                    <form @submit.prevent="login" class="mt-6 flex flex-col items-center w-full *:w-full gap-2">

                        <AuthInput v-model="formData.payload" :title="'payload'" :onupdate="updateFormData">
                        ...
                        <button :disabled="isLoading" type="submit"
                            ...
                            :class="{ 'opacity-70': validation.isFormNotValid }">
                            {{ isLoading ? 'Logging in...' : 'Log in' }}
                        </button>

                        <div class="relative border border-[#262626] my-3">
                            <span
                                class="absolute inset-0 w-12 z-10 px-3 h-5 flex items-center justify-center bg-black text-center m-auto text-secondary-text text-sm">
                                OR
                            </span>
                        </div>
                        ...
                        <div class="m-auto text-center cursor-pointer w-fit text-[#e0f1ff] text-sm">
                            Forgot password?
                        </div>
                    </form>
                </div>
