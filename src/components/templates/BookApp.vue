...
<template>
    <section class="flex items-center justify-center w-full m-auto p-8 h-auto py-28 bg-gray-200 text-black relative">
        ...
        <div class="max-w-[900px] w-full">
            <div class="flex items-center gap-2 justify-center text-center w-full m-auto pb-4">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 576 512"
                    class="size-8 text-orange-400" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <form @submit.prevent="add_book" class="flex flex-col space-y-3">
                ...
                <label>
                    ...
                    <input ref="first_book_form_input"
                        ...
                        :value="newBookData?.title ?? ''" class="w-full py-2 px-3 rounded-md border border-gray-800"
                ...
                <label>
                    ...
                    <input @change="e => update_book_form((e.target as HTMLInputElement).value, 'author')"
                        :value="newBookData?.author ?? ''" class="w-full py-2 px-3 rounded-md border border-gray-800"
                ...
                <label>
                    ...
                    <input @change="e => update_book_form((e.target as HTMLInputElement).value, 'year')"
                        :value="newBookData?.year ?? ''" class="w-full py-2 px-3 rounded-md border border-gray-800"
                        type="text" placeholder="Year of Book foundation">
                </label>
