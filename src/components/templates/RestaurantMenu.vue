...
<template>
  <section class="px-12 py-20 bg-red-100/25">
    <div class="container">
      ...
      <ul class="flex items-center mt-12 text-xl justify-center gap-4 ch:cursor-pointer ch:duration-200 text-orange-500">
        ...
        <li @click="filterType = 'lunch'" :class="{ activeMenu: filterType === 'lunch' }" class="py-2 px-6 rounded-xl">
          Lunch</li>
        <li @click="filterType = 'shakes'" :class="{ activeMenu: filterType === 'shakes' }" class="py-2 px-6 rounded-xl">
          Shakes</li>
      </ul>
